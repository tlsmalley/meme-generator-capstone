...
export default function MemeCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setImage1_url(initialValues.image1_url);
    setImage1_downloaded(initialValues.image1_downloaded);
    setImage1_rating(initialValues.image1_rating);
    setImage2_url(initialValues.image2_url);
    setImage2_downloaded(initialValues.image2_downloaded);
    setImage2_rating(initialValues.image2_rating);
    setImage3_url(initialValues.image3_url);
    setImage3_downloaded(initialValues.image3_downloaded);
    setImage3_rating(initialValues.image3_rating);
    setErrors({});
  };
  const validations = {
    untitledfield: [],
